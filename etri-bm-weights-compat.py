...
def main(argv=None):
    ...
    for profile in profiles:
        profs.append(profile['refs'])

    # Infer ELECTRE Tri parameters
    (iweights, iprofiles, ilbda, icompat, info) = etri_infer_parameters(learning_alts, criteria, pt, affectations, nprofiles, "models/etri_bm_weights_compat.mod", profiles=profs)
